...
unit1 = row1_col3.selectbox("Einheit", ("g/l", "mg/l", "°KMW", "vol.%"), key = "unit1")
...
unit2 = row2_col3.selectbox("Einheit", ("g/l", "mg/l", "°KMW", "vol.%"), key = "unit2")
...
if liquid1 and conc1 and liquid2 and conc2 and total_volume_l and total_concentration > 0:
    ...
    results_col2.metric(label=f"Gesamtkonzentration (in {unit1})", value=f"{total_concentration:.2f}")